...
#if defined( ARTVIS_WIN32 )
#	if defined( ARTVIS_ARTNET_BUILD )
#		define ARTVIS_ARTNET_API __declspec( dllexport )
#	else
#		define ARTVIS_ARTNET_API __declspec( dllimport )
#	endif
#else
#	define ARTVIS_ARTNET_API
#endif